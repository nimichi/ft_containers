...
/*   Updated: 2022/12/14 20:47:29 by mnies            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft {
	...
	class vector
	{
		public:
			...
			typedef iterator_f<random_access_iterator_tag, value_type>			iterator;
			typedef iterator_f<random_access_iterator_tag, const value_type>	const_iterator;
